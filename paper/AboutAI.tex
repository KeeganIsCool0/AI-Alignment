...
\begin{document}
	...
	How much problems do we have that scale into human extinction?
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1.0\linewidth]{../sources/Moors-Law}
		\caption{Moors Law Chart (Courtesy of Wikipedia)}
		\label{fig:moors-law}
	\end{figure}
